...
namespace Review4_.NET.Models
{
    public class Repo
    {
        ...
        //public static List<Item> Repos { get; set; }


        public Repo()
        {
            _visibility = "public";
            _affiliation = "mark11748";
        }

        public static List<Item> GetRepos()
        {
            var client = new RestClient("https://api.github.com");
            var request = new RestRequest("/search/repositories", Method.GET);

            request.AddParameter("sort", "star");
            request.AddParameter("order", "asc");
            request.AddParameter("q","user:mark11748");

            request.AddHeader("User-Agent",_affiliation);
            ...
            List<Item> repoList = JsonConvert.DeserializeObject<List<Item>>(jsonResponse["items"].ToString());
            return repoList;
        }
